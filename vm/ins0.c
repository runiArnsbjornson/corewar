...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/08/13 03:41:45 by yewen             #+#    #+#             */
/*   Updated: 2017/08/21 22:19:46 by jdebladi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	i_live(t_proc *proc)
{
	...
	if ((v = ft_array_find(c, proc->params, (int (*)(void *, void *))cmp_id))
		!= NULL)
	{
		v->nbr_live++;
